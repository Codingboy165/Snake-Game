...
public class GamePanel extends JPanel implements ActionListener {
    ...
    static final int GAME_UNITS = (SCREE_WIDTH * SCREE_HEIGHT) / UNIT_SIZE;
...
//                g.drawLine(0, i * UNIT_SIZE, SCREE_WIDTH, i * UNIT_SIZE);
//            }
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString("Game Over", (SCREE_WIDTH - metrics2.stringWidth("Game Over"))/2, SCREE_HEIGHT/2);
    }
